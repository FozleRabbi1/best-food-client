    ...
    return (
        <div className='bg-white p-10'>
            <Pdf targetRef={ref} options={options} filename="code-example.pdf">
                {({ toPdf }) => <button  className='text-white bg-green-300 w-full text-center mt-5 py-3 text-xl ' onClick={toPdf}>Download Blog Pdf</button>}
            </Pdf>


            <div ref={ref}>
                <h2 className="text-center mt-8 text-red-700 text-2xl ">...This is blog page...</h2>
                <div className="all-blogs  grid md:grid-cols-2 gap-10 py-10 " >
                    <div className="divOne">
                        <h2 className="text-red-500 mb-2 text-lg">
                            differences between uncontrolled and controlled components.
                        </h2>
                        <p className="text-sm">
                            <span>
                                Uncontrolled components refer to those parts of a system that are not actively managed or regulated. They may have a significant impact on the behavior of the system, but they are not subject to direct control.
                            </span>
                    ...
                    <div className="divFour">
                        ...
                        <p className='text-sm'>
                            ...
                            <ul>
                                <li>
                                    Reusability: If you find yourself repeating the same code in multiple components, it might be a good idea to create a custom hook to encapsulate that logic and reuse it wherever it is needed.
                                </li>
                                <li>
                                    Abstraction: Custom hooks can abstract away complex functionality, making it easier to use in other components. This can make your code more readable and easier to maintain.
                                </li>
                            </ul>
                        </p>
                    </div>
